...
import { FaEnvelope, FaMapMarkerAlt, FaLinkedin, FaGithub, FaLanguage } from 'react-icons/fa';
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex flex-col gap-2 w-full mb-6">
        <div className="flex items-center gap-2 text-base text-github-text dark:text-gray-700"><FaEnvelope /> jmcimanes@up.edu.ph</div>
        <div className="flex items-center gap-2 text-base text-github-text dark:text-gray-700"><FaMapMarkerAlt /> Manila, Philippines</div>
        <div className="flex items-center gap-2 text-base text-github-text dark:text-gray-700"><FaLinkedin /> <a href="https://linkedin.com/in/joshcimanes" className="hover:underline focus:underline transition-colors" target="_blank" rel="noopener noreferrer">LinkedIn</a></div>
        <div className="flex items-center gap-2 text-base text-github-text dark:text-gray-700"><FaGithub /> <a href="https://github.com/CimanesDev" className="hover:underline focus:underline transition-colors" target="_blank" rel="noopener noreferrer">GitHub</a></div>
      </div>
      <div className="hidden md:block w-full mb-2">
        <div className="flex items-center gap-2 mb-2 text-github-text dark:text-gray-700 font-semibold text-base">
          <FaLanguage className="text-lg" /> Languages
        </div>
